...
namespace schedule_api.Migrations
{
    ...
    [Migration("20250421155930_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("schedule_api.Models.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("schedule_api.Models.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("schedule_api.Models.Doctor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("schedule_api.Models.Appointment", b =>
                {
                    b.HasOne("schedule_api.Models.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("schedule_api.Models.Doctor", "Doctor")
                        .WithMany()
